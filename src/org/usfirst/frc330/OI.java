...
public class OI {
    ...
    public JoystickButton pickupOn_2;
    public JoystickButton pickupReverse_8;
    public JoystickButton disengageRatchet_9;
    ...
    public OI() {
        ...
        disengageRatchet_9 = new JoystickButton(armGamepad, 9);
        disengageRatchet_9.whenPressed(new DisengageRatchet());
        pickupReverse_8 = new JoystickButton(armGamepad, 8);
        pickupReverse_8.whileHeld(new PickupReverse());
        pickupOn_2 = new JoystickButton(armGamepad, 2);
        pickupOn_2.whileHeld(new PickupOn());
        ...
        SmartDashboard.putData("DisengageRatchet", new DisengageRatchet());
