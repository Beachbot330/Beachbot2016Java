...
import org.usfirst.frc330.commands.commandgroups.ShootLowerStage;
...
public class OI {
    ...
    public JoystickButton shootSoftest_3;
    ...
    public POVAnyButton pickupIntake;
    ...
    public OI() {
        ...
        shootSoftest_3 = new JoystickButton(driverL, 3);
        shootSoftest_3.whenPressed(new ShootLowerStage());
        ...
        SmartDashboard.putData("ShootLowerStage", new ShootLowerStage());
        SmartDashboard.putData("ShootLowerStageWithoutLid", new ShootLowerStageWithoutLid());
        SmartDashboard.putData("ShootUpperStageWithoutLid", new ShootUpperStageWithoutLid());

    // END AUTOGENERATED CODE, SOURCE=ROBOTBUILDER ID=CONSTRUCTORS
        
        pickupIntake = new POVAnyButton(armGamepad,0);
        pickupIntake.whileHeld(new PickupOn());
    }
