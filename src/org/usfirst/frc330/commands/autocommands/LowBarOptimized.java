...
public class LowBarOptimized extends BBCommandGroup {
    ...
    public  LowBarOptimized() {
        ...
        addSequential(new TurnGyroWaypoint(104, 270, 5, 3, ChassisConst.GyroTurnHigh));
        //double x, double y, double tolerance, double timeout, PIDGains gains
        addSequential(new DriveWaypoint(104, 270, 5, 5, true, ChassisConst.DriveHigh, ChassisConst.GyroDriveHigh));
        ...
        addSequential(new DriveWaypointBackward(0, 164, 5.0, 5.0, false, ChassisConst.DriveHigh, ChassisConst.GyroDriveHigh));
        //double x, double y, double tolerance, double timeout, boolean stopAtEnd, PIDGains driveGains, PIDGains gyroGains
    }
}
