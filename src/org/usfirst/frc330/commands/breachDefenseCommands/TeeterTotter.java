...
public class TeeterTotter extends BBCommandGroup {
    ...
    public  TeeterTotter() {
    	addSequential(new SetXYOffset(xOffset,0.0));
    	addParallel(new SetTurretPosition(TurretConst.center, 3.0, 20.0));
    	addSequential(new ShiftLow());
    	addParallel(new PickupOn());
    	addSequential(new DriveWaypoint(xOffset, distanceToTeeterY, 2.0, 15.0, false, driveLow, gyroDriveLow));
    	...
    	addSequential(new DriveWaypoint(xOffset, finishPositionY, 4.0, 15.0, false, ChassisConst.DriveHigh, ChassisConst.GyroDriveHigh));
    }
}
