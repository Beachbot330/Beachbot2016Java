...
public class Ramparts extends BBCommandGroup {
    ...
    public  Ramparts() {
    	...
    	addSequential(new DriveDistanceAtAbsAngle(164.0, 12.0, 0.0, 3.0, true, ChassisConst.DriveLow, ChassisConst.GyroDriveLow, ChassisConst.GyroTurnLow) ); // distance, tol, timeout, stop
